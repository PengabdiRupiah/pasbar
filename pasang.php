...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $selectQuery = "SELECT * FROM tb_4 WHERE id = $id";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $insertQuery = "INSERT INTO tb_5 (nama, alamat, dokumen, kondisi, p2tl, tunggakan) VALUES ('$nama', '$alamat', '$dokumen', '$kondisi', '$p2tl', '$tunggakan')";
        mysqli_query($conn, $insertQuery);

        $deleteQuery = "DELETE FROM tb_4 WHERE id = $id";
            ...
            <tbody>
                ...
                ?>
                        <tr>
                            ...
                            <td>
                                <?php if ($disabled == '') { ?>
                                <a class="next <?= $btn_class; ?>" href="insert_data3.php?id=<?= $pln['id']; ?>" <?= $disabled ?>>next</a>
